...
import { Trophy, User, BarChart2, History, Wrench, Users, Menu, X, LayoutDashboard, Flame, Target } from 'lucide-react';
...
const Navbar = () => {
    ...
    const navItems = [
        ...
        { href: `/league/${leagueId}/draft`, label: 'Draft', icon: Target },
