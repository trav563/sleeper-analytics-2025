                        ...
                        {rankings.map((team, idx) => {
                            ...
                            return (
                                <tr key={team.rosterId} className="border-b border-line hover:bg-bg-2/60 transition-colors duration-fast">
                                    ...
                                    <td className="px-3 py-3 text-center tnum text-text-dim hidden sm:table-cell">{team.ppg.toFixed(1)}</td>
                                    <td className="px-3 py-3 text-center tnum text-text-dim hidden md:table-cell">{(team.apWinPct * 100).toFixed(0)}%</td>
