        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div className="flex gap-3 w-full md:w-auto">
                    {/* Year Selector */}
                    <select
                        className="bg-slate-900 border border-slate-700 text-white text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-full px-4 py-2 appearance-none"
                    ...
                    {/* Team Selector */}
                    <select
                        className="bg-slate-900 border border-slate-700 text-white text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-full md:w-64 px-4 py-2 appearance-none"
